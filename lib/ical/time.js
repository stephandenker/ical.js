...
(function() {
   ...
   *
   */
  ICAL.Time.weeksInYear = function(year, wkst) {
    var wkst = wkst || ICAL.Time.MONDAY;
    var result = 52;
    ...
    //a year has 53 weeks, if the difference between the new year day
    //and the weekstart is 3 (or 2 in a leap year).
    //rfc5545: Assuming a Monday week start, week 53 can only occur,
    //when Thursday is Januaray the 1 or if it is a leap year and Wednesday
    //is January 1.
    var daysBetween = (newYearDay - wkst + 7) % 7;
    if (daysBetween == 3 || (ICAL.Time.isLeapYear(year) && daysBetween == 2)) {
      result = 53;
    }
